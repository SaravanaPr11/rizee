...
const DIALOG_NAME = "Dialog", [createDialogContext, createDialogScope] = createContextScope(DIALOG_NAME), [DialogProvider, useDialogContext] = createDialogContext(DIALOG_NAME), TRIGGER_NAME = "DialogTrigger", DialogTriggerFrame = styled(View, {
  ...
  return isAdapted ? /* @__PURE__ */ jsx(AdaptPortalContents, { children: content }) : /* @__PURE__ */ jsx(PortalItem, { hostName: context.adaptName, children: content });
}, DialogPortal = (props) => {
  ...
  if (context.modal) {
    const contents = /* @__PURE__ */ jsx(StackZIndexContext, { zIndex: resolveViewZIndex(zIndex), children: /* @__PURE__ */ jsx(AnimatePresence, { onExitComplete: handleExitComplete, children: isShowing || isAdapted ? children : null }) });
